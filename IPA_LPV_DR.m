...
figure (3)
subplot(2,1,1);
sigma(clrb_grid(1,1)/W1,'r',clnrn_grid(1,1)/W1,'b',clrbe_grid(1,1)/W1,'g',1/W1,'k--',omega);
title('Ref Sensitivity: Z1/r')
legend('S','1/We')

subplot(2,1,2);
sigma(clrb_grid(1,2)/W1,'r',clnrn_grid(1,2)/W1,'b',clrbe_grid(1,2)/W1,'g',1/W1,'k--',omega);
title('Wind effect sensitivity: Z1/d')
legend('SG','1/We')

figure (4)
subplot(2,1,1);
sigma(clrb_grid(2,1)/W2,'r',clnrn_grid(2,1)/W2,'b',clrbe_grid(2,1)/W2,'g',1/W2,'k--',omega);
title('Stearing control sensitivity: Z2/r')
legend('KS-del','1/Wu1')

subplot(2,1,2);
sigma(clrb_grid(2,2)/W2,'r',clnrn_grid(2,2)/W2,'b',clrbe_grid(2,2)/W2,'g',1/W2,'k--',omega);
title('Stearing control sensitivity: Z2/d')
legend('KS-del','1/Wu1')

figure (5)
subplot(2,1,1);
sigma(clrb_grid(3,1)/W2,'r',clnrn_grid(3,1)/W3,'b',clrbe_grid(3,1)/W3,'g',1/W3,'k--',omega);
title('Braking control sensitivity: Z3/r')
legend('KS-brk','1/Wu2')

subplot(2,1,2);
sigma(clrb_grid(3,2)/W2,'r',clnrn_grid(3,2)/W3,'b',clrbe_grid(3,2)/W3,'g',1/W3,'k--',omega);
